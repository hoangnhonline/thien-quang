<?php
define("BASE_URL",'http://chuathienquang.com/');
define("BASE_URL2",'http://chuathienquang.com/khiemthi/');
...
define('DB_NAME',  "chuathienquang");
define('USER_DB', "chuathienquang");
define('PASS_DB', "th13nqu@ng#2015");
...
define('SITE_DESCRIPTION','Chùa Thiên Quang hay Thiên Quang Ni tự toạ lạc tại phường Đông Hòa, thị xã Dĩ An, tỉnh Bình Dương. Chùa hiện do ni sư Hương Nhũ trụ trì. Chùa là nơi thường xuyên mở các khoá tu cho người khuyến thị và các bạn trẻ. ');
...
define('DIACHICHUA','Số 106/15 khu phố Đông Hòa, phường Dĩ An, huyện Dĩ An, tỉnh Bình Dương');
define('DIENTHOAICHUA','09999999999');
define('EMAILCHUA','AA@AA.COM');
...
define('DEFAULT_IDCHUDEVIDEO','1,2,4,5'); //các chủ đề video hiện ở trang chủ
