<form action="" method="post" id="chudemedia_them" class="form">
<h4>SỬA CHỦ ĐỀ MEDIA</h4>
<p><span>Tên chủ đề</span><input class=txt type=text name=tenchudemedia id=tenchudemedia value="<?php echo $row['tenchudemedia']?>"></p>
